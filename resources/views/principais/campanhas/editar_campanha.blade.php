                ...
                <div class="col-sm-4">
                    <div class="container p-3 bg-white shadow rounded">
                        ...
                        <form action="/campanha/update/{{ $campanha->id }}" method="POST" enctype="multipart/form-data"
                            ...
                            <input type="text" name="nome" id="nome" maxlength="50" value="{{ $campanha->nome }}"
                                class="form-control" oninput="nome_att()" required>
                            ...
                            <input type="text" name="telefone" id="tel" maxlength="14" value="{{ $campanha->telefone }}"
                                data-mask="(00)00000-0000" class="form-control" required>


                            <label for="email" class="mt-3">E-mail de contato</label>
                            <input type="email" name="email" id="email" maxlength="100" value="{{ $campanha->email }}"
                            ...
                            <input type="text" name="pixKey" id="pixKey" maxlength="32" class="form-control"
                                value="{{ $campanha->pixKey }}" required>
                            ...
                            <input type="text" name="titular" id="titular" maxlength="100" class="form-control"
                                value="{{ $campanha->titular }}" required>
                            ...
                            <textarea name="descricao" id="descricao" class="form-control"
                                maxlength="240">{{ $campanha->descricao }}</textarea>
