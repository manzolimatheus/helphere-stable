        ...
        <div class="row mt-3 mb-3">
            <div class="col-sm-4">
                <div class="container p-3 bg-white shadow rounded">
                    ...
                    <form action="/campanha/update/{{ $campanha->id }}" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="checkbox" name="voluntarios" id="voluntarios" onclick="AtivaEndereco()" @if ($campanha->endereco !== null)
                        checked
                        @endif
                        >
                        ...
                        <div id="div_endereco" @if ($campanha->endereco === null)
                            ...
                            <input type="text" name="endereco" id="endereco" value="{{ $campanha->endereco }}" class="form-control">
                        </div>
                        ...
                        <textarea name="descricao" id="descricao" class="form-control">{{ $campanha->descricao }}</textarea>
            ...
            <div class="col-sm-8">
                ...
                <div class="container bg-white rounded shadow w-100 text-center p-3">
                    ...
                    <hr>
                    <div class="container">
                        <img src="{{ $campanha->img_path }}" class="w-100 rounded-bottom" style="width: 800; height: 300px; object-fit: cover;" id="preview">
                    </div>
