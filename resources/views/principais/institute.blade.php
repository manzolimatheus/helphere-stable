            ...
            <div class="modal-body">
                ...
                <form action="/doar" method="POST" enctype="multipart/form-data">
                    ...
                    <div hidden>
                        ...
                        <input type="tel" name="id_instituicao" id="id_instituicao" value="{{ $institute->id }}" class="form-control">
                    </div>
                    ...
                    <div class="col-10">
                        <div class="container">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control text-muted bg-white" readonly value="127.0.0.1:8000/instituicao/{{ $institute->id }}" aria-describedby="link" id="linkToCopy">
                            </div>
                            <h6>Compartilhe também nas redes sociais!</h6>
                            <a class="btn bg-cinzaEscuro rounded-pill" target="_blank" href="https://twitter.com/intent/tweet?text=Olá! Estou utilizando o HelpHere para ajudar pessoas e ser ajudado. Venha fazer o bem você também! 😊HelpHere&hashtags=HelpHere">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/enviar_mensagem/{{ $criador['id'] }}" method="post">
                    ...
                    <a data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample"><b>O que são os recados?</b>
...
<div class="container">
    ...
    <div class="container bg-white rounded shadow w-100 text-center">
        ...
        <div class="container">
            <img src="{{ $institute->image }}" alt="{{ $institute->nome_instituicao }}" class="w-100 rounded-bottom" style="width: 800; height: 300px; object-fit: cover;">
        </div>
        ...
        <div class="container p-3">
            ...
            <div class="row">
                ...
                <div class="col-sm p-1">
                    <button class="btn bg-verde-agua w-100 p-3 text-white rounded-pill" data-bs-toggle="modal" data-bs-target="#ModalDoar">
                        <b>Apoiar causa</b>
                    </button>
                </div>
                {{-- Coluna 2 --}}
                <div class="col-sm p-1">
                    <button class="btn btn-info w-100 p-3 text-white rounded-pill" data-bs-toggle="modal" data-bs-target="#ModalCompartilhar">
                        <b>Compartilhar</b>
                    </button>
                </div>
                <div class="col-sm p-1">
                    <button class="btn bg-roxo w-100 p-3 text-white rounded-pill" data-bs-toggle="modal" data-bs-target="#ModalMensagem">
                        <b>Deixar recado</b>
                    </button>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            ...
            <div class="col-sm-5 container bg-white rounded shadow p-3 mt-3 w-100 text-center" style="height: fit-content">
                <p>
                    ...
                    <ion-icon name="cash-outline" class="me-2 text-muted"></ion-icon> Doações recebidas no último mês!
                <div class="text-center">

                    <h3><strong>
                            <ion-icon name="trending-up-outline" class="text-success"></ion-icon> R$ {{$paymentLastMonth}}
                        </strong></h3>
                    </a>
                </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="container bg-white rounded shadow p-3 mt-3 w-100 text-center" style="height: fit-content">
                        ...
                        <a href="/perfil/{{ $criador['id'] }}">
                            ...
                            <img src="https://ui-avatars.com/api/?name={{ urlencode($criador['name']) }}&color=7F9CF5&background=EBF4FF" alt="Imagem de perfil" class="img-perfil rounded-circle mini-bloco">
                            @else
                            <img src="/storage/{{ $criador['profile_photo_path'] }}" alt="Imagem de perfil" class="img-perfil rounded-circle mini-bloco">
                            @endif
                        </a>
                    </div>
                </div>
                <div class="col">
                    <div class="container bg-white rounded shadow p-3 mt-3 w-100 text-center" style="height: fit-content;">
                        <b>Categoria</b>
                        <br>
                        <div class="text-center rounded mini-bloco w-100" style="background-image: linear-gradient(rgba(0, 0, 0, 0.527),rgba(0, 0, 0, 0.5)) ,url('https://source.unsplash.com/200x100/?{{ $categoria['categoria_ingles'] }}'); background-size:cover;">
        ...
        <div class="col-sm-7">
            ...
            <div class="container bg-white shadow p-3 mt-3 rounded">
                ...
                {{-- Formulário --}}
                <form class="mb-3" action="/post_institute/{{ $institute->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <label for="text">Mensagem</label>
                    <textarea name="data" id="text" class="form-control" required placeholder="O que você deseja compartilhar com a comunidade?"></textarea>
                    <div class="row mt-3">
                        <label for="image">
                            <ion-icon name="image-outline" class="text-success me-2"></ion-icon>Enviar imagem
                        </label>
                        <div class="col-sm mt-1">
                            <input type="file" name="image" id="image" class="form-control w-100 rounded-pill" accept="image/*" onchange="validateImage()">
                        </div>
                        <div class="col-sm mt-1">
            ...
            @if (count($posts) < 1) <div class="container bg-white rounded shadow p-3 mt-3 mb-3">
                <div class="container text-center">
                    <h5 class="mt-3">Esse perfil não apresenta nenhuma postagem! :(</h5>
                    <div class="container p-3 mt-3 mb-3">
                        <lottie-player src="https://assets4.lottiefiles.com/packages/lf20_ydo1amjm.json" background="transparent" speed="1" loop autoplay></lottie-player>
                    </div>
                </div>
        </div>
        @else
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm mb-1">
                                    ...
                                    <form action="/post_delete/{{ $post->id }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="border-0 bg-white" onclick="return confirm('Deseja realmente deletar esse post? Essa é uma ação sem volta!');">
                                ...
                                <div class="col-sm">
                                    <form action="/report_post_institute/{{ $post->id }}" method="POST">
                                        @csrf
                                        <button type="submit" class="border-0 bg-white" onclick="return alert('Post reportado! Nossa equipe verificará o ocorrido o mais rápido possível! 😉');">
