<x-jet-action-section>
    <x-slot name="title">
        <strong>{{ __('Sessões de Navegador') }}</strong>
    </x-slot>

    <x-slot name="description">
        {{ __('Gerencie e deslogue de sua sessões ativas em outros navegadores e dispositivos.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" class="btn bg-verde-agua text-white rounded-pill" wire:loading.attr="disabled">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor, digite sua senha para confirmar que você gostaria de deslogar de outros navegadores em todos os seu dispositivos.') }}
            ...
            <x-slot name="footer">
                ...
                <x-jet-button class="ml-2 btn bg-verde-agua text-white rounded-pill"
