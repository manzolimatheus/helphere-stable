            ...
            <div class="container p-5 mt-3 rounded bg-white shadow">
                ...
                <section id="faq">
                        ...
                        <article>
                            ...
                            <details>
                                <summary></summary>
                            <p>Pode ser que algum dado referente à geração do QRCode PIX para doações, como Chave PIX, nome do titular da conta ou
                        ...
                        <article>
                            ...
                            <details>
                                <summary></summary>
                            <p>Para isso, você deve entrar em contato com a instituição, por meio do e-mail cadastrado e agendar sua visita para realizar a
                ...
                <section id="problemSolutions">
                        ...
                        <article>
                            ...
                            <details>
                                <summary></summary>
                            <p>Como dito na resposta acima, o representante, na hora de cadastrar sua instituição, acabou por digitar incorretamente algum dado referente a
                ...
                <section id="htd">
                        ...
                        <article>
                            ...
                            <details>
                                <summary></summary>
                            <p>Basta clicar no botão escrito "Criar instituição", presente na pagina inicial. Após clicar no botão
                        ...
                        <article>
                            ...
                            <details>
                                <summary></summary>
                            <p>Ao abrir o site em seu navegador, você deve clicar no botão de login. Após clicar no botão,
                        ...
                        <article>
                            ...
                            <details>
                                <summary></summary>
                            <p>Basta ir até o seu perfil, ou o perfil de sua Instituição, ir até o campo de postagens e escrever sua mensagem ou selecionar uma 
                        ...
                        <article>
                            ...
                            <details>
                                <summary></summary>
                            <p>Na pagina da instituição escolhida, clique no botão "Apoiar causa" e uma janela se abrirá. Nessa janela você colocará o valo que deseja doar 
